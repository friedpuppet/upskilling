...
public class JdbcPersistence implements Persistence {
    ...
    public JdbcPersistence(JdbcConnector jdbcConnector) throws PersistenceException {
    ...
    private PreparedStatement getNewIdStatement(Connection connection) throws SQLException {
        String NEWID_SQL = "select max(id) + 1 as new_id  from products";
    ...
    private PreparedStatement getAddStatement(Connection connection) throws SQLException {
        String ADD_SQL = "insert into products(id, name, price) values (?, ?, ?)";
    ...
    private PreparedStatement getGetAllStatement(Connection connection) throws SQLException {
        ...
        String GETALL_SQL = "select id, name, price from products";
    ...
    private PreparedStatement getGetStatement(Connection connection) throws SQLException {
        String GET_SQL = "select id, name, price from products where id = ?";
