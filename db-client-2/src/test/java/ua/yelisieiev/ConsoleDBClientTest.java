...
import static ua.yelisieiev.config.ConfigParam.*;
 ...
 * </table>
 * **/
public class ConsoleDBClientTest {
/**
 create with error
 drop with error
 ...
 */
  ...
  private ConsoleDBClient dbClient;
    ...
    void create_ClientWithInMemoryDb() throws IOException {
        ...
        dbClient = new ConsoleDBClient(config);
        dbClient.setEchoMode(true);
